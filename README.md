...
- Or the [Wiki](https://github.com/doapply/voip/wiki) section.

- View the [Changelog](CHANGELOG.md)

- Report [Security Issues](SECURITY.md)

- [Troubleshooting](https://github.com/doapply/VoIP/wiki/Troubleshooting) tips
...
![GitHub forks](https://img.shields.io/github/forks/doapply/voip?style=flat-square)
![GitHub](https://img.shields.io/github/license/doapply/voip?style=flat-square)
